...
program
  ...
  .option('--duration <seconds>', 'Max recording duration', '30')
  .option('--scroll-steps <n>', 'Number of scroll steps', '5')
  .option('--scroll-delay <ms>', 'Delay between scrolls', '800')
  .option('--click-buttons', 'Click interactive elements (use with caution)')
